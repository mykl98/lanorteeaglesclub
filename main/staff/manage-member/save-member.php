...
if($_POST){
    ...
    function saveMember($idx,$name,$address,$contact,$profession,$status,$club){
        ...
        if($idx == ""){
            ...
            $sql = "INSERT INTO `$table` (name,club,username,password,access,status,address,contact,profession) VALUES ('$name','$club','$userPass','$userPass','member','$status','$address','$contact','$profession')";
        }else{
