...
<head>
    ...
    <title>Staff | Survey Result</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-success float-right btn-sm" onclick="exportToExcel()">Export CSV</button>
                                <div class="input-group mb-3 float-left w-25 input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success">FILTER</span>
                                    </div>
                                    <select class="form-control" id="filter" onchange="filterChange()">
                                        <option value="press">President</option>
                                        <option value="vpress">Vice President</option>
                                        <option value="sen">Senator</option>
                                        <option value="rep">Representative</option>
                                        <option value="gov">Governor</option>
                                        <option value="vgov">Vice Governor</option>
                                        <option value="sp">SP Member</option>
                                        <option value="mayor">Mayor</option>
                                        <option value="vmayor">Vice Mayor</option>
                                        <option value="sb">SB Member</option>
                                        <option value="party">Partylist</option>
                                    </select>
                                </div>
                            </div>
                            <div class="card-body">
                                <div id="surveyresult-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--Table2Exel-->
<script src="<?php echo $baseUrl;?>/system/plugin/table2excel/jquery.table2excel.min.js"></script>
