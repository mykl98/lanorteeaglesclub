...
<head>
    ...
    <title>Admin | Manage Respondent</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Respondents</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">System Settings</a></li>
                                <li class="breadcrumb-item active">Manage Respondent</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Respondent List</h3>
                                <button class="btn btn-sm bg-success float-right" onclick="addRespondent()"><span class="fa fa-plus"></span> Add Respondent</button>
                            </div>
                            <div class="card-body">
                                <div id="respondent-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-respondent-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-respondent-modal-title">Create New Respondent</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="respondent-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="respondent-name">
                        </div>
                        <div id="barangay-select-container"></div>
                        <div id="purok-select-container"></div>
                    </form>
                    <p id="add-edit-respondent-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="saveRespondent()">Save</button>
                </div>
            </div>
        </div>
    </div>
