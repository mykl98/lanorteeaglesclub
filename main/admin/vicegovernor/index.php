...
<head>
    ...
    <title>Admin | Vice Governor</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Vice Governor</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Manage Candidates</a></li>
                                <li class="breadcrumb-item active">Vice Governor</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Governor List</h3>
                                <button class="btn btn-sm bg-success float-right" onclick="addViceGovernor()"><span class="fa fa-plus"></span> Add Vice Governor</button>
                            </div>
                            <div class="card-body">
                                <div id="vicegovernor-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-vicegovernor-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-vicegovernor-modal-title">Create New Vice Governor</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="vicegovernor-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="vicegovernor-name">
                        </div>
                        <div class="form-group">
                            <label for="vicegovernor-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="vicegovernor-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-vicegovernor-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="saveViceGovernor()">Save</button>
                </div>
            </div>
        </div>
    </div>
