...
<head>
    ...
    <title>Admin | Vice President</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Vice President</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Vice President List</h3>
                                <button class="btn btn-sm bg-success float-right" onclick="addVicePresident()"><span class="fa fa-plus"></span> Add Vice President</button>
                            </div>
                            <div class="card-body">
                                <div id="vicepresident-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-vicepresident-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-vicepresident-modal-title">Create New Vice President</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="vicepresident-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="vicepresident-name">
                        </div>
                        <div class="form-group">
                            <label for="vicepresident-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="vicepresident-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-vicepresident-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="saveVicePresident()">Save</button>
                </div>
            </div>
        </div>
    </div>
