...
<head>
    ...
    <title>Admin | Manage Barangay</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm bg-success float-right" onclick="addBarangay()"><span class="fa fa-plus"></span> Add Barangay</button>
                            </div>
                            <div class="card-body">
                                <div id="barangay-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-barangay-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-barangay-modal-title">Create New Barangay</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="barangay-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="barangay-name">
                        </div>
                        <div class="form-group">
                            <label for="barangay-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="barangay-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-barangay-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="saveBarangay()">Save</button>
                </div>
            </div>
        </div>
    </div>
