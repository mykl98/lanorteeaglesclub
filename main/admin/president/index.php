...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">President</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">President List</h3>
                                <button class="btn btn-sm bg-success float-right" onclick="addPresident()"><span class="fa fa-plus"></span> Add President</button>
                            </div>
                            <div class="card-body">
                                <div id="president-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-president-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-president-modal-title">Create New President</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="president-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="president-name">
                        </div>
                        <div class="form-group">
                            <label for="president-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="president-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-president-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="savePresident()">Save</button>
                </div>
            </div>
        </div>
    </div>
