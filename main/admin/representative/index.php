...
<head>
    ...
    <title>Admin | Representative</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Representative</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Manage Candidates</a></li>
                                <li class="breadcrumb-item active">Representative</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Representative List</h3>
                                <button class="btn btn-sm bg-success float-right" onclick="addRepresentative()"><span class="fa fa-plus"></span> Add Representative</button>
                            </div>
                            <div class="card-body">
                                <div id="representative-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-representative-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-representative-modal-title">Create New Representative</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="representative-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="representative-name">
                        </div>
                        <div class="form-group">
                            <label for="representative-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="representative-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-representative-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="saveRepresentative()">Save</button>
                </div>
            </div>
        </div>
    </div>
